...
const externalLink = computed(() => {
  const formattedName = characterName.value.replace(/\s+/g, '_')
  return `https://bulbapedia.bulbagarden.net/wiki/${formattedName}_(Trainer)`
})
  ...
  <v-row v-if="characterName">
    ...
    <v-col cols="12" md="8">
      <WikiCard :title="`${characterName} Overview`" icon="mdi-shield-star" class="mb-6">
        <p class="text-body-1">{{ characterName }} Overview Text here</p>
      </WikiCard>
