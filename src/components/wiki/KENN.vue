...
// Destructuring props to use them directly in the template
const { 
  news, 
  color = 'blue', 
  interval = 8000 
...
.terminal-glow {
  text-shadow: 0 0 10px currentColor, 0 0 2px rgba(255, 255, 255, 0.5);
}
...
@keyframes flicker {
  0%, 18%, 22%, 25%, 53%, 57%, 100% { opacity: 1; filter: blur(0px); }
  20%, 24%, 55% { opacity: 0.3; filter: blur(0.5px); }
}
