...
export default {
  id: "one-on-one-tauros-competition",
  title: "One-on-One Tauros Competition",
  category: "theme-tournament",
  regions: ["johto"],
  image: "Tauros_Competition_battle.png",
  description:
  ...
  bulba:
    "https://bulbapedia.bulbagarden.net/wiki/Pok%C3%A9mon_Swap_Meet",
